...
function SkillPill(props: SkillPillProps) {
  ...
  return (
    <div className="flex w-max items-center gap-2 overflow-hidden rounded-lg border border-tera-500/20 bg-white px-4 py-3 text-sm shadow-sm dark:bg-zinc-800 sm:text-base md:px-6 md:py-3">
      {icon}
...
export default function Skills() {
  ...
  return (
    <section id="skills" className="overflow-hidden px-6 py-20 sm:px-14 md:px-20">
      <div className="relative mx-auto max-w-7xl">
        <h2 className="text-3xl font-semibold sm:text-4xl">Skills</h2>
        <AnimatePresence>
          <div className="mt-4">
            <span className="font-semibold">Languages</span>
            <div className="mt-2 flex flex-wrap gap-4 dark:text-zinc-100">

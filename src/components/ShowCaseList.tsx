...
export default function ShowCaseList(props: TShowCaseList) {
  ...
  return (
    <div id={props.title === "Experience" ? "experience" : "education"} className="mx-auto max-w-7xl px-6 sm:px-14 my-20 md:px-20">
      <h2 className="md:mb-30 mb-16 w-full bg-gradient-to-r from-teal-400 to-tera-500 bg-clip-text text-center text-3xl font-bold text-transparent dark:from-teal-200 dark:to-teal-500 xs:text-4xl">
        {props.title}
      </h2>

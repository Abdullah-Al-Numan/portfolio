...
export default function Navbar(props: TNavbar) {
  ...
  const handleScroll = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>, isToggleModal: boolean) => {
    e.preventDefault();
    if (isToggleModal) {
      toggleModal();
    }
  ...
  return (
    <header className="sticky top-0 z-50 mt-2 px-6 py-8 sm:mt-8 sm:px-14 md:px-20">
      <div className="mx-auto flex items-center justify-between lg:max-w-7xl">
        <Link
          href="/"
          onClick={(e) => setCurrentHref(e.currentTarget.href)}
